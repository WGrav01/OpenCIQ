...
*Note: an exception is made for test cases, due to the tedium of writing them. The test cases are a mix of human and LLM code.*
*Nothing outside of test cases has been generated by an LLM.*
